...
.fr-text{
  ...
  <body class="horizontal-layout horizontal-menu blank-page navbar-floating footer-static  " data-open="hover" data-menu="horizontal-menu" data-col="blank-page">
              ...
              <div class=" d-none d-lg-flex col-lg-8 align-items-center p-5 ">
                 <div class="w-100 d-lg-flex align-items-center justify-content-center px-5 imgDiv"  id="imgDiv">
				          <div id="carousel-example-caption" class="carousel slide" data-bs-ride="carousel">
				            ...
				            <div class="carousel-inner">
				              <div class="carousel-item active">
				                <img class="img-fluid" src="<c:url value="/resources/images/Automatic-Weighbridge.jpg"/>" alt="First slide" />
				    ...
				    <%--           <div class="carousel-item">
				         ...
				         <%--        <div class="carousel-item">
				                <img class="img-fluid" src="<c:url value="/resources/images/SafetyP22.png"/>" alt="Third slide" />
				                <div class="carousel-caption d-none d-md-block">
				                  <!-- <p class="text-white">
				                    Pudding sweet pie gummies. Chocolate bar sweet tiramisu cheesecake chocolate cotton candy pastry
				                    muffin. Marshmallow cake powder icing.
				                ...
				                <div class="carousel-item">
				                <img class="img-fluid" src="<c:url value="/resources/images/Safety2P3.png"/>" alt="Third slide" />
				                <div class="carousel-caption d-none d-md-block">
				                  <!-- <p class="text-white">
				                    Pudding sweet pie gummies. Chocolate bar sweet tiramisu cheesecake chocolate cotton candy pastry
				                    muffin. Marshmallow cake powder icing.
				              ...
				              <div class="carousel-item">
				                <img class="img-fluid" src="<c:url value="/resources/images/Saf2etyP4.jpeg"/>" alt="Third slide" />
				                <div class="carousel-caption d-none d-md-block">
				                  <!-- <p class="text-white">
				                    Pudding sweet pie gummies. Chocolate bar sweet tiramisu cheesecake chocolate cotton candy pastry
				                    muffin. Marshmallow cake powder icing.
              ...
              <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-2">
               <!-- Login basic -->
                ...
                <h3><strong>Welcome to</strong></h3>
                  ...
                  <h4 class="mb-2">WEIGHBRIDGE Portal</h4>
	...
	<!-- 			 <div id="g_id_onload"
             ...
             <div class="m-t-30 "><p class="font-10 fr-text">WeighBride © 2023. ReSL, All Rights Reserved.</p></div>
                </div>
    	...
    	window.handleCredentialResponse = (response) => {
    		  ...
    		  if('${success}' == null || '${success}' == ''){
	    		  if('${invalidEmail}' == null || '${invalidEmail}' == ''){
	    			 ...
	    			 //alert(responsePayload.getEmail()+" do not have access to login. Please try with registered mail account (or) contact to admin.");
	    			 $("#loginForm").submit();
			      }
