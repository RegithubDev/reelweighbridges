...
<head>
    ...
    <title>Ramky-Weighbridges</title>
    <!-- Bootstrap Core CSS -->
                        ...
                        <li>
                            ...
                            <ul aria-expanded="false" class="collapse">
                             ...
                             <li><a href="<%=request.getContextPath() %>/dashboard-wb-cnd">CND Cumulative Dashboard</a></li>     <%--  <li><a href="<%=request.getContextPath() %>/dashboard-wb-bmw">BMW Cumulative Dashboard</a></li> --%>
								 <li><a href="CND_Cumulative_Dashboard.php">CND Cumulative Dashboard</a></li>
								<li><a href="CND_Daily_Dashboard.php">CND Daily Dashboard</a></li>
								<li><a href="Msw_Daily_Dashboard.php">MSW Daily Dashboard</a></li>
								<li><a href="Msw_Cumulative_Dashboard.php">MSW Cumulative Dashboard</a></li>
                                ...
                                <li><a href="wbreport.php">IWM Reports</a></li>
								 <li><a href="cndwbreport.php">C&D Reports</a></li>
								  <li><a href="mswreport.php">MSW Reports</a></li>
                            </ul>
                        </li>
                    </ul>
                </nav>
    ...
    <%--             <div class="row page-titles">
         		...
         		<div class="row page-titles">
                    <div class="col-md-6 col-8 align-self-center">
                        ...
                        <h3 class="text-themecolor m-b-0 m-t-0">MSW Cumulative Transactions Dashboard</h3>
                ...
                <div class="row" id="mainDashBoard">
                    <!-- Column -->
                    <c:forEach var="obj" items="${sitesList}">
                    <div class="col-lg-3 col-md-6">
                      <div <c:if test="${obj.project_Status ne 'Active' }">style="background-color: #808080;"</c:if>>
                        <div class="card" >
                            <div class="card-body">
                                <h4 class="card-title">${obj.project }</h4>
                                <div class="text-right"><b>${obj.count }</b>  
                                    ...
                                    <span class="text-muted">Sync From&nbsp;:&nbsp; ${obj.min }</span><br>
	  								<span class="text-muted">To&nbsp; ${obj.DATEIN }
										</span>
	                                </div>
	                            </div>
	                             </div>
...
<span class="text-muted">To&nbsp;:&nbsp; </span>
            ...
            <!-- footer -->
         <footer class="footer">
                <p class="text">© 2020 <a href="http://www.ramkyenviroengineers.com" rel="nofollow">Ramky Enviro Engineers Limited</a> </p>
            </footer>
            <!-- ============================================================== -->
            <!-- End footer -->
            <!-- ============================================================== -->
