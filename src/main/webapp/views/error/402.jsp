...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="/reelweighbridges/resources/assets/images/favicon.png">
    <!-- Custom CSS -->
    <link href="/reelweighbridges/resources/css/style.min.css" rel="stylesheet">
...
<div class="main-wrapper">
      ...
      <div class="error-box">
        <div class="error-body text-center">
          <h3 class="error-title text-success">200</h3>
          <h3 class="text-uppercase error-subtitle">No Data Found!</h3>
    ...
    <!-- All Required js -->
    <!-- ============================================================== -->
    <script src="/reelweighbridges/resources/assets/plugins/chartist-js/dist/libs/jquery/dist/jquery.min.js"></script>
    <!-- Bootstrap tether Core JavaScript -->
    <script src="/reelweighbridges/resources/assets/plugins/chartist-js/dist/libs/bootstrap/dist/js/bootstrap.bundle.min.js"></script>
    <!-- ============================================================== -->
    <!-- This page plugin js -->
    <!-- ============================================================== -->
    <script>
