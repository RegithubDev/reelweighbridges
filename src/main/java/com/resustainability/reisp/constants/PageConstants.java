...
public class PageConstants {
	...
	public static final String MSWdashboard = "MSWdashboard";	
	public static final String CNDdashboard = "CNDdashboard";	
	public static final String BMWdashboard = "BMWdashboard";	
	public static final String dailyWeighBridge = "dailyWeighBridge";
	...
	public static final String newReport = "newReport";
